...
class LecturerAssignmentDetailPage extends StatefulWidget {
  final MaterialModel assignment;

  const LecturerAssignmentDetailPage({super.key, required this.assignment});

  @override
  State<LecturerAssignmentDetailPage> createState() => _LecturerAssignmentDetailPageState();
}

class _LecturerAssignmentDetailPageState extends State<LecturerAssignmentDetailPage> {
  ...
  Future<void> _fetchSubmissions() async {
    ...
    final submissions = await repo.getAssignmentSubmissions(widget.assignment.id);
    if (mounted) {
      setState(() {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                  ...
                  children: [
                    ...
                    if (widget.assignment.fileUrl.isNotEmpty) ...[
                      ...
                      OutlinedButton(
                        ...
                        child: const Text('Download Lampiran Soal'),
                      ),
                    ],
                  ],
                ),
            ...
            Text('Pengumpulan Tugas', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold)),
            const SizedBox(height: 12),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            leading: CircleAvatar(
                              child: Text(submission.studentName?[0] ?? 'S'),
